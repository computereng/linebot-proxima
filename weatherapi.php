...
for($cdd = 1; $cdd <= 5; $cdd++){
  ...
  $date = $parsed_json->{'dailysummary'}->{'date'}->{'date'};
  $tzname = $parsed_json->{'dailysummary'}->{'date'}->{'tzname'};
  $maxtempm = $parsed_json->{'dailysummary'}->{'date'}->{'maxtempm'};
  $mintempm = $parsed_json->{'dailysummary'}->{'date'}->{'mintempm'};
