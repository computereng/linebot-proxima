...
for($cdd = 1; $cdd <= 5; $cdd++){
  ...
  $date = $parsed_json->{'history'}->{'dailysummary'}->{'date'}->{'date'};
  $tzname = $parsed_json->{'history'}->{'dailysummary'}->{'date'}->{'tzname'};
  $maxtempm = $parsed_json->{'history'}->{'dailysummary'}->{'date'}->{'maxtempm'};
  $mintempm = $parsed_json->{'history'}->{'dailysummary'}->{'date'}->{'mintempm'};
