<?php
  $db = pg_connect('host=ec2-54-235-173-161.compute-1.amazonaws.com dbname=davg135f89ndd9 user=nssvhpjghqgfui password=b32e79395f1d23198ce048097efca1604cf445e0fcabac8ae48f95b15ace1d81');
 /// 
...
///
  ...
  $query = "INSERT INTO friends(date, temp, location) VALUES('" . $date . "', '" . $temp . "', '" . $location . "')";
